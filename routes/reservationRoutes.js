...
const { requireAuth, requireAdmin } = require("../middleware/middleware_auth");
...
router.get("/admin-reservations", requireAdmin, reservationController.getAllReservationsAdmin);

// Create reservation (called from booking flow)
router.post("/api/reservations", requireAuth, reservationController.createReservation);
