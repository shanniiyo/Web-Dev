...
exports.updateSeat = async (req, res) => {
  try {
    ...
    // Ownership check: passengers may only modify their own reservations
    // (admins are not routed through this endpoint)
    if (String(reservation.user) !== String(req.session.user.id)) {
...
exports.cancelReservation = async (req, res) => {
  try {
    ...
    // Ownership check: passengers may only cancel their own reservations
    if (String(reservation.user) !== String(req.session.user.id)) {
